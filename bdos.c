...
static FILE *lookfp( z80info *z80, unsigned where ) {
    ...
    for ( i = 0; i < storedfps; ++i )
        if ( stfps[ i ].where != 0xffffU && !memcmp( z80->mem + z80->regde + 1, stfps[ i ].name, 11 ) ) {
...
static void fcberr( z80info *z80, unsigned where ) {
    ...
    fprintf( stderr,
             "error: cannot find fp entry for FCB at %04x"
             " fctn %d, FCB named %s\n",
             where, z80->regbc & 0xff, z80->mem + where + 1 );
    for ( i = 0; i < storedfps; ++i )
        if ( stfps[ i ].where != 0xffffU )
...
#define ADDRESS ( ( (long)z80->mem[ z80->regde + FCB_R0 ] + (long)z80->mem[ z80->regde + FCB_R1 ] * 256 ) * 128L )
...
char *bdos_decode( int n ) {
    ...
    case 19:
        return "delete file (no wildcards yet)";
    case 20:
        return "read sequential";
    case 21:
        return "write sequential";
    case 22:
        return "make file";
    case 23:
        return "rename file";
    case 24:
        return "return login vector";
    case 25:
        return "return current disk";
    case 26:
        return "Set DMA Address";
    case 27:
        return "Get alloc addr";
    case 28:
        return "Set r/o vector";
    case 29:
        return "return r/o vector";
    case 30:
        return "Set file attributes";
    case 31:
        return "get disk parameters";
    case 32:
        return "Get/Set User Code";
    case 33:
        return "read random record";
    case 34:
        return "write random record";
    case 35:
        return "compute file size";
    case 36:
        return "set random record";
#ifdef CPM3DATE
    case 105:
...
int bdos_fcb( int n ) {
    ...
    case 16:
        return 1; /* "close file"; */
    case 17:
        return 1; /* "search for first"; */
    case 18:
        return 1; /* "search for next"; */
    case 19:
        return 1; /* "delete file (no wildcards yet)"; */
    case 20:
        return 1; /* "read sequential"; */
    case 21:
        return 1; /* "write sequential"; */
    case 22:
        return 1; /* "make file"; */
    case 23:
        return 1; /* "rename file"; */
    case 30:
        return 1; /* set attribute */
    case 33:
        return 1; /* "read random record"; */
    case 34:
        return 1; /* "write random record"; */
    case 35:
        return 1; /* "compute file size"; */
    case 36:
        return 1; /* "set random record"; */
    default:
        return 0;
    }
}
...
void bdos_fcb_dump( z80info *z80 ) {
    ...
    buf[ 12 ] = 0;
    printf( "DR=%x F='%s' EX=%x S1=%x S2=%x RC=%x CR=%x R0=%x R1=%x R2=%x\n", z80->mem[ DE + 0 ], buf, z80->mem[ DE + 12 ],
            z80->mem[ DE + 13 ], z80->mem[ DE + 14 ], z80->mem[ DE + 15 ], z80->mem[ DE + 32 ], z80->mem[ DE + 33 ],
...
static unsigned char bcd_byte( int b ) { return ( ( ( b % 100 ) / 10 ) << 4 ) | ( b % 10 ); }
...
static void unix_to_cpm_time( const time_t *tp, struct cpm_time *ct_p ) {
    ...
    if ( tm_p->tm_year < 78 ) {
        ...
        ct_p->day = (int)( ( t_this - t_first + ( 12 * 60 * 60 ) ) / ( 24 * 60 * 60 ) + tm_p->tm_yday + 1 );
...
void check_BDOS_hook( z80info *z80 ) {
    ...
    if ( trace_bdos ) {
        ...
        for ( i = 0; i < 8; ++i )
            printf( " %4x", z80->mem[ SP + 2 * i ] + 256 * z80->mem[ SP + 2 * i + 1 ] );
        printf( ")\r\n" );
    }
    switch ( C ) {
    case 0: /* System Reset */
